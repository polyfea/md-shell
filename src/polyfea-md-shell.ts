...
export class PolyfeaMdShell extends LitElement {
  ...
  @property({ type: String, attribute: 'theme-brand-font' }) themeBrandFont: string = "";
  /** theme plain font family (implicit 'Roboto Flex Variable', 'Roboto Flex', Roboto, sans-serif) */
  @property({ type: String, attribute: 'theme-plain-font' }) themePlainFont: string = "";
  /** theme icon font family (implicit 'Material Symbols Outlined Variable', 'Material Symbols Outlined') */
  @property({ type: String, attribute: 'theme-icon-font' }) themeIconFont: string = "";
  ...
  #applyDesignTokens(): string {
    ...
    let tokens = '';
    tokens += `--md-ref-typeface-brand: ${this.themeBrandFont || "'Roboto Slab Variable', 'Roboto Slab', serif"};\n`;
    tokens += `--md-ref-typeface-plain: ${this.themePlainFont || "'Roboto Flex Variable','Roboto Flex', Roboto, sans-serif"};\n`;
    ...
    tokens +=
      Object.entries(typescale)
        ...
        tokens += `--md-icon-font: ${this.themeIconFont || "'Material Symbols Outlined Variable', 'Material Symbols Outlined'"};\n`;
    const shapes = {
      'corner-none': 0,
