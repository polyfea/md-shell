...
const meta: Meta<PolyfeaMdShellProps> = {
  ...
  argTypes: {
    ...
    mainContentContext: {
      name: 'main-content',
      description: 'Main content element(s). E.g . &lt;polyfea-md-apps&gt; for landing page or custom content on functionality pages.' + 
    ...
    topbarLeadingContext: {
      ...
      description: 'Leading icon element. Only one element is taken from the context' + 
    ...
    topbarTrailingContext: {
      ...
      description: 'Trailing icon element. Only one element is taken from the context' + 
    ...
    topBarMenuItemsContext: {
      ...
      description: 'Menu item elements. If no elements are provided then elements slotted to slot "topbar-menu-items" are used.',
      control: false,
      table: {
      category: 'Polyfea Contexts',
      },
    ...
    navigationContentContext: {
      ...
      description: 'Navigation content elements. Maximum 5 elements are taken from the context. Elements  &lt;polyfea-md-app&gt; are tuned for usage in this context. If no elements are provided then elements slotted to slot "navigation" are used. ',
      control: false,
      table: {
      category: 'Polyfea Contexts',
      },
    ...
    railPrimaryActionsContext: {
      ...
      description: 'Rail primary actions (e.g. FAB). Only one element is taken. If no elements are provided then elements slotted to slot "rail-primary-action" are used. ',
      control: false,
      table: {
      category: 'Polyfea Contexts',
      },
    ...
    railContentContext: {
      name: 'rail-content',
      description: 'Rail navigation content. Maximum 7 elements are taken from the context. Elements  &lt;polyfea-md-app&gt; are tuned for usage in this context. If no elements are provided then elements slotted to slot "rail" are used.',
      control: false,
      table: {
      category: 'Polyfea Contexts',
      },
    ...
    drawerContentContext: {
      name: 'drawer-content',
      description: 'Drawer content elements (E.g. &lt;polyfea-md-app&gt; or &lt;polyfea-md-drawer-label&gt;). If no elements are provided then elements slotted to slot "drawer" are used.',
      control: false,
      table: {
      category: 'Polyfea Contexts',
      },
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story: 'The default configuration of the `polyfea-md-shell` component. It containts top bar, navigation rail, drawer, and navigation bar' 
...
export const MediumSize: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Shows how the shell renders in a medium-sized viewport (e.g., tablet). The layout behavior changes based on breakpoints attributes.',
      },
    },
  },
  args: {
...
export const SmallSize: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Shows how the shell renders in a small-sized viewport (e.g., mobile). Elements like the rail are hidden and bottom navigation bar is shown.',
      },
    },
  },
  args: {
...
export const LargeSize: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Shows how the shell renders in a large-sized viewport (e.g., desktop). Typically displays a persistent rail or drawer.',
      },
    },
  },
  args: {
...
export const Localized: Story = {
  parameters: {
    docs: {
      description: {
        story: 'The shell supports localization by providing context to register locale loaders and allowing to change the locale (see <polyfea-md-locale-menu> element).' +
...
export const Theming: Story = {
  parameters: {
    docs: {
      description: {
        story: 'The shell supports theming via CSS custom properties. Theme palettes and font types can be customized. ',
      },
    },
  },
  args: {
...
export const Drawer: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Drawer behaviour depends on media size, here shown in medium size viewport. The drawer can be opened/closed via events or buttons in the top bar and drawer itself.',
      },
    },
  },
  args: {
...
export const ScrollableContent: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Top bar reflects scroll state of the main content area by applying specific  background-color  based on scroll position.',
      },
    },
  },
  args: {
...
export const AllDisabled: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Configuration with all navigation areas (drawer, rail, navigation bar) disabled, showing mostly just the content and top bar.',
      },
    },
  },
  args: {
...
export const TopbarVariants: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Top bar variant may be also configured (e.g., centered, small, medium, large). This can affect headline size and positioning.',
      },
    },
  },
  args: {
